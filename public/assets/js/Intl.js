(function() {
     ...
     * take the steps to bring a language tag into 鈥渆xtlang form鈥� and to reorder
     * variant subtags.
     ...
     * host environment鈥檚 current locale.
     */
    ...
    function /* 9.2.2 */$$core$$BestAvailableLocale (availableLocales, locale) {
        ...
        while (true) {
            ...
            // c. If pos 鈮� 2 and the character "-" occurs at index pos-2 of candidate,
    ...
    function $$core$$FormatNumber (numberFormat, x) {
        ...
        // 3. Else
            ...
            //    numberFormat matches one of the values in the 鈥淣umbering System鈥� column
            ...
            if ($$core$$numSys[nums]) {
                ...
                //    鈥淒igits鈥� column of Table 2 in the row containing the value of the
    ...
    function $$core$$ToRawPrecision (x, minPrecision, maxPrecision) {
        ...
        // 3. Else
            ...
            // a. Let e and n be integers such that 10岬栤伝鹿 鈮� n < 10岬� and for which the
            //    exact mathematical value of n 脳 10岬夆伝岬栤伜鹿 鈥� x is as close to zero as
            //    possible. If there are two such sets of e and n, pick the e and n for
            //    which n 脳 10岬夆伝岬栤伜鹿 is larger.
            var
        ...
        // 6. If e 鈮� 0, then
            ...
            //    ".", and the remaining p鈥�(e+1) characters of m.
            m = m.slice(0, e + 1) + '.' + m.slice(e + 1);

        // 7. If e < 0, then
        else if (e < 0)
            // a. Let m be the concatenation of the String "0.", 鈥�(e+1) occurrences of the
        ...
        if (m.indexOf(".") >= 0 && maxPrecision > minPrecision) {
            var
            // a. Let cut be maxPrecision 鈥� minPrecision.
    ...
    function $$core$$ToRawFixed (x, minInteger, minFraction, maxFraction) {
        ...
        var idx,
            ...
            // 6. Let cut be maxFraction 鈥� minFraction.
        ...
        if (igr < minInteger)
            // a. Let z be the String consisting of minInteger鈥搃nt occurrences of the
            //    character "0".
    ...
    function $$core$$FormatDateTime(dateTimeFormat, x) {
        ...
        for (var p in $$core$$dateTimeComponents) {
            ...
            if ($$core$$hop.call(internal, '[['+ p +']]')) {
                ...
                //  iv. If p is "year" and v 鈮� 0, then let v be 1 - v.
                if (p === 'year' && v <= 0)
                    v = 1 - v;
        ...
        if (internal['[[hour12]]'] === true) {
            ...
            //    value representing 鈥減ost meridiem鈥�; else let fv be an implementation and
            //    locale dependent String value representing 鈥渁nte meridiem鈥�.
